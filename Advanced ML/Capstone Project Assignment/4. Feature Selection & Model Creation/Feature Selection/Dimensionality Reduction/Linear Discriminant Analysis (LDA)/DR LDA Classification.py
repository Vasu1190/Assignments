...
def lda_Classification(acclog,accsvml,accsvmnl,accknn,accnav,accdes,accrf): 
    ...
    kpcadataframe=pd.DataFrame(index=['LDA'],columns=['Logistic','SVMl','SVMnl',
...
for kernel in kernels:
    ...
    # Check if the length of indep_X_lda matches your original dataset
   
    #if len(indep_X_lda) != len(dep_Y):
